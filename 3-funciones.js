...
console.log(multiplicar(1, 5)); // 5
console.log(saludarPersonalizado("Hola", "Amira")); // "Hola, Amira "
console.log(calcularPotencia(3, 3)); // 27
console.log(restar(10, 4)); // 6
console.log(dividir(20, 4)); // 5
console.log(multiplicarDOS(3, 5)); // 15
console.log(saludar("Amira")); // "Hola, Amira "
